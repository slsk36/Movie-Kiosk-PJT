...
namespace KIOSK_v1
{
    public partial class uc4_seat : UserControl
    {
        ...
        public void Select(Label lbl)  
        {
            ...
            Console.WriteLine("인원 수 : " + uc3_roundPeople.roundPeopleInst.Person + "\n");
        ...
        // 티켓에서 selected 찾아서 booked 에서 삭제 (보정 요망)
        ...
        public bool idTest(string tID)
        {
            try
            {
                ...
                foreach(DataRow dr in dt.Rows)
                {
                    ...
                    Console.WriteLine(i+"번 ticketID 검사 : "+ testID + " / " + tID);
                }
        ...
        public void pay_Click(object sender, EventArgs e)
        {
            ...
            {
                getBooked();
                bool selectedExists = seatInst.Booked.Contains(seatInst.Selected);

                //★특정문자 검색★
                //string s = "Hello World";
                //bool stringExists = s.Contains("ello"); // 존재 여무 (true or false)
                //int locationFront = s.IndexOf("ello");  // 앞에서 몇번째?
                //int locationBack = s.LastIndexOf("l");  // 뒤에서 몇번째?
