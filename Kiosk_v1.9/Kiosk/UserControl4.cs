...
namespace Kiosk
{
    public partial class UserControl4 : UserControl
    {
        ...
        public UserControl4(int adult,int youth) //uc3의 인원을 가져오기위한 매개변수 선언 - 유니나
        {
            this.adult = adult;
            this.youth = youth;
        }
        ...
        private void pay_Click(object sender, EventArgs e)
        {
            if (!Main.Instance.pnlContainer.Controls.ContainsKey("UserControl5"))
            {
                ...
                UserControl5.seat = selectedSeats.Text; // 좌석 선택 한 번호 a5,a4
                uc5.sum.Text = sum.Text; // 총 금액
